function testForm(){
  var SDOR = $('#sdor').val(),         //  наименование СДЯВ
      ...
      test1 = /\d{1,}[^a-zA-ZА-ЯЁа-яё]+/;
      var y = test1.test(VOLUME);
      alert(y);
      if (y == true){alert("OK!!!");} else {alert("ERROR-R-R  !!!!!!");}
  return SDOR, VOLUME, V, T;
}

function calculation (SDOR, VOLUME, V, T) {
var VSP = $('#VSP').val(),           //  степень вертикальной устойчивости воздухa
...
// Определение времени испарения СДЯВ (без учета наличия поддона для некоторых емкостей)!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    alert(SDOR + "    " + VSP + "    " + VOLUME + "    " + V);
    alert("Глубина распостранения первичного облака (табличное значение) " + G1T + " км");
    alert("Глубина распостранения вторичного облака (табличное значение) " + G2T + " км");
    alert("Коэффициент пропорциональности Кк равен  " + KK + "\n" + "Коэффициент Kt1 равен " + KT1 + "\n" + "Коэффициент Kt2 равен " + KT2);
    alert("Коэффициент рассеивания СДЯВ равен  " + KR + "\n" + "Коэффициент влияния местности составляет  " + KM);
    alert("Глубина распространения первичного облака СДЯВ составляет  " + G1 + " км" + "\n" + "Глубина распространения вторичного облака СДЯВ составляет  " + G2 + " км");
    alert("Радиус аварии равен  " + RA + " км" + "\n" + "Угол Фі1 равен " + FI1 + "\n" + "Угол Фі2 равен " + FI2);
    alert("Время испарения СДЯВ с площади разлива при скорости ветра 1 м/с составляет  " + TIMEEVA + " часов");
    alert("S1 = " + S1 + " км кватратных" + "\n" + "S2 = " + S2 + " км кватратных");
